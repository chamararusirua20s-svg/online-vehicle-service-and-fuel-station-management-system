...
<head>
    ...
    <title>AutoCare | User Login</title>
...
<body class="bg-slate-900 flex items-center justify-center min-h-screen px-4">
    <div class="w-full max-w-md p-8 space-y-6 bg-slate-800 shadow-xl rounded-3xl">
        ...
        <!-- Title -->
        <h2 class="text-4xl font-extrabold text-center text-green-400">User Login</h2>
        <p class="text-center text-gray-400 text-sm mb-6">Sign in to manage your AutoCare account</p>
        ...
        <!-- Login Form -->
        <form class="space-y-5" action="${pageContext.request.contextPath}/client/login" method="POST">
        ...
        <div class="text-center text-sm mt-4 text-gray-400">
            ...
            <a href="${pageContext.request.contextPath}/client/register" class="text-green-400 hover:underline">Register here</a>
        </div>

        <!-- Footer Note -->
        <p class="text-center text-gray-500 text-xs mt-6">AutoCare – User Access Portal</p>
    </div>
