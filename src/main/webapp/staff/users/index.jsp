                ...
                <c:forEach var="user" items="${users}">
                  <tr class="border-b border-slate-700 hover:bg-slate-700/50">
                    ...
                    <td class="px-6 py-4 text-center space-x-3">
                      <a href="${pageContext.request.contextPath}/staff/user?action=delete&id=${user.userId}" onclick="return confirm('Are you sure you want to delete this user?');" class="text-red-400 hover:text-red-500">
